...
urlpatterns = [
    ...
    path("my-volunteering-history/" , MyVolunteeringHistory.as_view(), name="my-volunteering-history"), #my volunteering history   
    ...
    path('bulk-requests/<str:organization_name>/send-blood/', SendBloodForRequestView.as_view(), name='send_blood_for_request'),
    ]
