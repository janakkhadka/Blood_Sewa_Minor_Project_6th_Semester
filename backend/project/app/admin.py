...
from .models import User, Volunteer , BulkRequestmodel ,BloodRequestModel , Event , UserEvent , BloodInventory , Bookings 
...
class EventAdmin(admin.ModelAdmin):
    ...
    fields = ('name', 'slug', 'description', 'location', 'date', 'collabrator', 'organizer', 'qr_code', 'donor_attendee_count' , 'start_time' , 'end_time' , 'expected_donor_count','volunteer_attendee_count','volunteer_required_count' , 'collaboration_status' , 'collected_blood')
